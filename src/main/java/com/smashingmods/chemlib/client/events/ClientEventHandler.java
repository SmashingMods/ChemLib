...
public class ClientEventHandler {
	...
	public static void onModelRegister(ModelEvent.RegisterAdditional event) {
        event.register(new ModelResourceLocation(ResourceLocation.fromNamespaceAndPath(ChemLib.MODID, "item/element_solid_model"), "standalone"));
        event.register(new ModelResourceLocation(ResourceLocation.fromNamespaceAndPath(ChemLib.MODID, "item/element_liquid_model"), "standalone"));
        event.register(new ModelResourceLocation(ResourceLocation.fromNamespaceAndPath(ChemLib.MODID, "item/element_gas_model"), "standalone"));
        event.register(new ModelResourceLocation(ResourceLocation.fromNamespaceAndPath(ChemLib.MODID, "item/chemical_dust_model"), "standalone"));
        event.register(new ModelResourceLocation(ResourceLocation.fromNamespaceAndPath(ChemLib.MODID, "item/chemical_nugget_model"), "standalone"));
        event.register(new ModelResourceLocation(ResourceLocation.fromNamespaceAndPath(ChemLib.MODID, "item/chemical_ingot_model"), "standalone"));
        event.register(new ModelResourceLocation(ResourceLocation.fromNamespaceAndPath(ChemLib.MODID, "item/chemical_plate_model"), "standalone"));
        event.register(new ModelResourceLocation(ResourceLocation.fromNamespaceAndPath(ChemLib.MODID, "item/compound_dust_model"), "standalone"));
	}
}