    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ItemRegistry.getElements().forEach(element ->
                registration.addIngredientInfo(
                        ...
                        MutableComponent.create(new TranslatableContents("chemlib.jei.element.description", null, TranslatableContents.NO_ARGS))));
        ...
        ItemRegistry.getCompounds().forEach(compound ->
                registration.addIngredientInfo(
                        ...
                        MutableComponent.create(new TranslatableContents(
                                String.format("chemlib.jei.compound.%s.description", compound.getChemicalName()),
                                null,
