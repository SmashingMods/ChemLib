    ...
    public static List<MobEffectInstance> mobEffectsFactory(JsonObject object) {
        ...
        if (effects != null) {
            for (JsonElement effect : effects) {
                ...
                ResourceLocation id = ResourceLocation.parse(effectLocation);
                BuiltInRegistries.MOB_EFFECT.getHolder(id).ifPresent(holder -> effectsList.add(new MobEffectInstance(holder, effectDuration, effectAmplifier)));
            }
        }
        return effectsList;
    }
