...
public class ItemRegistry {
    ...
    public static final DeferredRegister<Item> REGISTRY_ELEMENTS = DeferredRegister.create(Registries.ITEM, ChemLib.MODID);
    public static final DeferredRegister<Item> REGISTRY_COMPOUNDS = DeferredRegister.create(Registries.ITEM, ChemLib.MODID);
    public static final DeferredRegister<Item> REGISTRY_COMPOUND_DUSTS = DeferredRegister.create(Registries.ITEM, ChemLib.MODID);
    public static final DeferredRegister<Item> REGISTRY_METAL_DUSTS = DeferredRegister.create(Registries.ITEM, ChemLib.MODID);
    public static final DeferredRegister<Item> REGISTRY_NUGGETS = DeferredRegister.create(Registries.ITEM, ChemLib.MODID);
    public static final DeferredRegister<Item> REGISTRY_INGOTS = DeferredRegister.create(Registries.ITEM, ChemLib.MODID);
    public static final DeferredRegister<Item> REGISTRY_PLATES = DeferredRegister.create(Registries.ITEM, ChemLib.MODID);
    public static final DeferredRegister<Item> REGISTRY_BLOCK_ITEMS = DeferredRegister.create(Registries.ITEM, ChemLib.MODID);
    public static final DeferredRegister<Item> REGISTRY_MISC_ITEMS = DeferredRegister.create(Registries.ITEM, ChemLib.MODID);
    ...
    public static Optional<Item> getChemicalBlockItemByName(String pName) {
        return REGISTRY_BLOCK_ITEMS.getEntries().stream()
                ...
                .filter(item -> item.getDefaultInstance().getItem().toString().endsWith(pName))
                .findFirst()
                .map(item -> (Item) item);
    }
    ...
    public static <B extends Block> void fromChemicalBlock(DeferredHolder<Block, ? extends Block> pBlock, Item.Properties pProperties) {
        REGISTRY_BLOCK_ITEMS.register(pBlock.getId().getPath(), () -> new ChemicalBlockItem((ChemicalBlock) pBlock.get(), pProperties));
    }

    public static <B extends Block> void fromBlock(DeferredHolder<Block, ? extends Block> pBlock, Item.Properties pProperties) {
